              ...
              <div class="card-content">
                  <div class="media">
                      <div class="media-content has-text-centered">
                          <p class="title article-title">SIIIIUUUUUUUUUU</p>
                          <div class="tags has-addons level-item">
                              <span class="tag is-rounded is-info">@moha</span>
                  ...
                  <div class="content article-body">
                      ...
                      <h3 class="has-text-centered">SIUIUUUUUUUUUUUUUUUU</h3>
              ...
              <div class="card-content">
                  <div class="media">
                      <div class="media-center">
                          <img src="https://upload.wikimedia.org/wikipedia/commons/8/8c/Cristiano_Ronaldo_2018.jpg" class="author-image" alt="Placeholder image">
                      </div>
                      <div class="media-content has-text-centered">
                          <p class="title article-title">Sapien eget mi proin sed 🔱</p>
                          <p class="subtitle is-6 article-subtitle">
                              <a href="#">@moha</a> on February 17, 202X
                          </p>
                      </div>
                  </div>
                  <div class="content article-body">
              ...
              <div class="card-content">
                  <div class="media">
                      ...
                      <div class="media-content has-text-centered">
                          ...
                          <p class="subtitle is-6 article-subtitle">
                              <a href="#">@moha</a> on October 7, 202X
                          </p>
                      </div>
                  </div>
                  <div class="content article-body">
