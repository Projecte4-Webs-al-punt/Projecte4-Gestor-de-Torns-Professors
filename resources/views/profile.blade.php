                                        ...
                                        <div class="p-3 py-5">
                                            ...
                                            <div class="row mt-2">
                                                <div class="m-4"><label class="labels">Nom</label>
                                                    <input type="text" class="input is-dark" name="name" placeholder="Nom"
                                                        value="{{ $user->name }}">
                                                </div>
                                                <div class="m-4"><label class="labels">Cognoms</label>
                                                    <input type="text" class="input is-dark" name="lastname"
                                                        value="{{ $user->lastname }}" placeholder="Cognoms">
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="m-4"><label class="labels">Correu
                                                        Electrònic</label>
                                                    <input type="text" class="input is-dark" name="email"
                                                        placeholder="exemple@cendrassos.net" value="{{ $user->email }}">
                                                </div>
                                                <div class="m-4"><label class="labels">Telèfon</label>
                                                    <input type="text" class="input is-dark" name="phone"
                                                        placeholder="000 000 000" value="{{ $user->phone }}">
                                                </div>
