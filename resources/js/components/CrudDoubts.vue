        ...
        <tr v-for="(doubt, index) in doubts.data" :key="index">
          ...
          <td class="is-actions-cell">
            <div class="buttons is-right">
              <button v-on:click="showModal('1', doubt.id)" class="button is-small is-primary" type="button">
                <span class="icon"><i class="fas fa-eye"></i></span>
              </button>
              <button v-on:click="showModal('2', doubt.id)" class="button is-small is-warning jb-modal" data-target="sample-modal" type="button">
                <span class="icon"><i class="fas fa-reply"></i></span>
              </button>
              <button v-on:click="showModal('3', doubt.id)" class="button is-small is-danger jb-modal" data-target="sample-modal" type="button">
  ...
  methods: {
    ...
    showModal(accions, id) {
      ...
      if (!this.openModal) {
        this.openModal = true;
        if (accions === "1") {
          document.getElementById("ModalShowMessage").classList.add("is-active");
          ...
          document.getElementById("ModalDeleteDoubts").classList.add("is-active");
    ...
    hideModal() {
      if (this.openModal) {
        ...
        if (this.actionModal === "1") {
          document.getElementById("ModalShowMessage").classList.remove("is-active");
          this.list();
        } else if (this.actionModal === "2") {
          document.getElementById("ModalSendDoubt").classList.remove("is-active");
          this.list();
        } else if (this.actionModal === "3") {
          document.getElementById("ModalDeleteDoubts").classList.remove("is-active");
          this.list();
        }
